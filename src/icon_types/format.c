/**
 * @file format.c
 * @brief Icon format detection and size extraction implementation
 * 
 * This module provides low-level icon format parsing including:
 * - NewIcon format detection via tooltypes
 * - OS3.5 FORM/ICON chunk detection
 * - Icon size extraction from various formats
 * - Icon position reading
 */
