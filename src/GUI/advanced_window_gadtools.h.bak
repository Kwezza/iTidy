...
struct iTidyAdvancedWindow
{
    ...
    struct Gadget *block_gap_cycle;  /* Gap size between blocks in Grouped by Type mode */
    ...
    UWORD block_gap_selected;           /* Index: 0=Small, 1=Medium, 2=Large (for Grouped by Type mode) */
